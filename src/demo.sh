...
# training
python3 main.py --model MSFFRN  --scale 2 --n_resblocks 10 --n_feats 64 --n_columns 4  --dir_data <DIV2K_dir> --data_train DIV2K --data_test DIV2K --save MSFFRN_x2  --patch_size 96 --epochs 1000 --decay 200-400-600-800

python3 main.py --model MSFFRN  --scale 3 --n_resblocks 10 --n_feats 64 --n_columns 4  --dir_data <DIV2K_dir> --data_train DIV2K --data_test DIV2K --save MSFFRN_x3  --patch_size 144 --epochs 1000 --decay 200-400-600-800

python3 main.py --model MSFFRN  --scale 4 --n_resblocks 10 --n_feats 64 --n_columns 4  --dir_data <DIV2K_dir> --data_train DIV2K --data_test DIV2K --save MSFFRN_x4  --patch_size 192 --epochs 1000 --decay 200-400-600-800


# testing
python3 main.py --model MSFFRN  --scale 2 --n_resblocks 10 --n_feats 64 --n_columns 4  --dir_data <benchmark_dir> --data_test Set5+Set14+B100+Urban100 --save MSFFRN_x2  --load MSFFRN_x2 --pre_train ../experiment/MSFFRN_x2/model/model_best.pt --test_only

python3 main.py --model MSFFRN  --scale 3 --n_resblocks 10 --n_feats 64 --n_columns 4  --dir_data <benchmark_dir> --data_test Set5+Set14+B100+Urban100 --save MSFFRN_x3  --load MSFFRN_x3 --pre_train ../experiment/MSFFRN_x3/model/model_best.pt --test_only

python3 main.py --model MSFFRN  --scale 4 --n_resblocks 10 --n_feats 64 --n_columns 4  --dir_data <benchmark_dir> --data_test Set5+Set14+B100+Urban100 --save MSFFRN_x4  --load MSFFRN_x4 --pre_train ../experiment/MSFFRN_x4/model/model_best.pt --test_only
